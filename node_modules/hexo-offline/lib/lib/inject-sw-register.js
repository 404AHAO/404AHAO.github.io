...
const injectSWRegisterWithContent = script => publicDir => {
  const indexHTMLPath = _path.default.join(publicDir, "index.html"); // early return when no index.html presets in public directory
  ...
  const fileContent = _fs.default.readFileSync(indexHTMLPath, "utf-8"); // early return if it has been injected before
...
var _default = injectSWRegisterWithContent(helperSWRegister());
